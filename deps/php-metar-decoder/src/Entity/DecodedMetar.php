...
class DecodedMetar
{
    ...
    // temperature information
    private $Cair_temperature;
    private $Cdew_point_temperature;
    ...
    public function getCAirTemperature()
    {
        return $this->Cair_temperature;
    }
    ...
    public function setCAirTemperature($temperature)
    {
        $this->Cair_temperature = $temperature;
    }
    ...
    public function getCDewPointTemperature()
    {
        return $this->Cdew_point_temperature;
    }
    ...
    public function setCDewPointTemperature($temperature)
    {
        $this->Cdew_point_temperature = $temperature;
